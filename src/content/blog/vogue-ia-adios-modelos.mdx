...
cover: 'https://res.cloudinary.com/dkb9jfet8/image/upload/v1739925181/ai_vogue_model_placeholder.jpg'
...
<h2 id="vogue-y-el-debate-de-la-ia-en-la-moda">Vogue y el debate de la IA en la moda</h2>
...
<h2 id="el-impacto-de-la-ia-en-la-creatividad">El impacto de la IA en la creatividad</h2>
...
<h2 id="vision-ia-punto">La visión de IA Punto: Potenciando la creatividad humana</h2>
...
1.  <a href="https://techcrunch.com/2025/08/03/the-uproar-over-vogues-ai-generated-ad-isnt-just-about-fashion/" target="_blank" rel="noopener noreferrer">TechCrunch: The uproar over Vogue’s AI-generated ad isn’t just about fashion (Fecha estimada: 3 de agosto de 2025)</a>

<div class="flex flex-wrap gap-2 mt-8">
  <span class="inline-block px-3 py-1 bg-primary-100 text-primary-700 text-xs font-semibold rounded-full shadow-sm">Media & Entertainment</span>
  <span class="inline-block px-3 py-1 bg-primary-100 text-primary-700 text-xs font-semibold rounded-full shadow-sm">AI</span>
  <span class="inline-block px-3 py-1 bg-primary-100 text-primary-700 text-xs font-semibold rounded-full shadow-sm">Fashion</span>
  <span class="inline-block px-3 py-1 bg-primary-100 text-primary-700 text-xs font-semibold rounded-full shadow-sm">Digital Fashion Models</span>
  <span class="inline-block px-3 py-1 bg-primary-100 text-primary-700 text-xs font-semibold rounded-full shadow-sm">Creatividad Humana</span>
