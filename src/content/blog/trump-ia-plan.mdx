Aquí tienes el contenido formateado según tu ejemplo:
...
cover: 'https://res.cloudinary.com/dkb9jfet8/image/upload/v1739925181/trump_ia_plan.png' # URL de imagen genérica, ya que no se proporcionó una en el contenido.
