```markdown
---
title: 'De Dispo al acero: El sorprendente cambio de un co-fundador tech.'
slug: 'cofundador-tech-dispo-acero'
pubDate: 'Jul 28 2025'
description: 'Descubre la historia de Daniel Liss, cofundador de Dispo y Teaser AI, quien dejó el mundo de las apps para incursionar en la fabricación de acero, buscando un impacto tangible y duradero más allá del ecosistema digital.'
cover: 'https://res.cloudinary.com/dkb9jfet8/image/upload/v1739925181/steel_tech_shift_example.jpg'
coverAlt: 'Daniel Liss haciendo el cambio de tecnologia a la fabricación de acero'
author:
  name: 'Sergio Rondón'
...
<h2 id="el-salto-inesperado-de-tech-al-acero">El Salto Inesperado: De Tech al Acero</h2>
...
<h2 id="por-que-el-acero-la-vision-de-un-inquieto">¿Por Qué el Acero? La Visión de un Inquieto</h2>
...
<h2 id="ia-punto-y-la-innovacion-en-industrias-tradicionales">IA Punto y la Innovación en Industrias Tradicionales</h2>
...
<h2 id="el-camino-hacia-adelante-y-el-impacto-real">El Camino Hacia Adelante y el Impacto Real</h2>
...
<a href="https://techcrunch.com/2025/07/28/why-dispos-co-founder-made-the-leap-from-social-media-to-steelmaking/" target="_blank" rel="noopener noreferrer">TechCrunch: Why Dispo’s co-founder made the leap from social media to steelmaking</a>
...
<div class="flex flex-wrap gap-2 mt-8">
  ...
  <span class="inline-block px-3 py-1 bg-primary-100 text-primary-700 text-xs font-semibold rounded-full shadow-sm">Daniel Liss</span>
  ...
  <span class="inline-block px-3 py-1 bg-primary-100 text-primary-700 text-xs font-semibold rounded-full shadow-sm">Siderurgia</span>
  <span class="inline-block px-3 py-1 bg-primary-100 text-primary-700 text-xs font-semibold rounded-full shadow-sm">Industria Tradicional</span>
</div>
```