...
<div class="flex flex-wrap gap-2 mt-8">
  <span class="text-xs bg-gray-100 dark:bg-gray-800 px-3 py-1 rounded-full">PYMES</span>
  <span class="text-xs bg-gray-100 dark:bg-gray-800 px-3 py-1 rounded-full">Inteligencia Artificial</span>
  <span class="text-xs bg-gray-100 dark:bg-gray-800 px-3 py-1 rounded-full">Marketing Digital</span>
  <span class="text-xs bg-gray-100 dark:bg-gray-800 px-3 py-1 rounded-full">Automatización</span>
  <span class="text-xs bg-gray-100 dark:bg-gray-800 px-3 py-1 rounded-full">Ventas</span>
</div>