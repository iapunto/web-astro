...
async function main() {
  console.log('🔍 Validando artículos no aprobados con fecha 2025...\n');
  ...
  fs.writeFileSync(
    'validation-2025-report.json',
    JSON.stringify(detailedReport, null, 2)
  );
  console.log('📄 Reporte detallado guardado en: validation-2025-report.json');
